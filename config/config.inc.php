...
/*fix parametres price */
define('_PS_DOLLAR_EXCHANGE_RATE_', Configuration::get('PS_SHOP_DOLLAR_EXCHANGE_RATE'));
define('_PS_SHOP_MARKUP_', (int)Configuration::get('PS_SHOP_MARKUP'));
