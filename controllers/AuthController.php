		...
		{  //echo "<pre>";
           ...
           if(!isset($_POST['visible_adress'])){
            ...
            if(!empty($_POST['phone_mobile'])){
               $customer->phone  =  $_POST['phone_mobile'];
            }
			...
			$lastnameAddress = ucfirst($_POST['lastname']);
			$firstnameAddress = ucfirst($_POST['firstname']);
            $middlenameAddress = ucfirst($_POST['middlename']);
			$_POST['lastname'] =ucfirst($_POST['customer_lastname']);
			$_POST['firstname'] = ucfirst($_POST['customer_firstname']);
            $_POST['middlename'] = ucfirst($_POST['customer_middlename']);
				...
				if (!count($this->errors))
				{
				   ...
				   if (!$customer->add())
				    ...
				    if (!$customer->is_guest)
				    {
				       ...
				       array('{firstname}' => $customer->firstname, '{middlename}' => $customer->middlename, '{lastname}' => $customer->lastname, '{email}' => $customer->email, '{passwd}' => Tools::getValue('passwd')), $customer->email, $customer->firstname.' '.$customer->lastname))
				       $this->errors[] = Tools::displayError('Cannot send email');
                                ...
                                self::$cookie->customer_middlename = $customer->middlename;
