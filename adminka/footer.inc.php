...
<a style="position:relative; top:-35px; left:650px;" href="https://metrika.yandex.ru/stat/?id=21308263&amp;from=informer"
target="_blank" rel="nofollow"><img src="https://informer.yandex.ru/informer/21308263/3_0_5AB1FFFF_3A91E8FF_0_pageviews"
style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" class="ym-advanced-informer" data-cid="21308263" data-lang="ru" /></a>
<!-- /Yandex.Metrika informer -->
HTMLSTART;
echo '
		</div></div>
...
(function(w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter21308263 = new Ya.Metrika({id:21308263, enableAll: true});
        }
        catch(e) { }
    });
