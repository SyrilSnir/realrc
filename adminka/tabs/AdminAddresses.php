...
class AdminAddresses extends AdminTab
{
	...
	public function __construct()
	{
        ...
        'middlename' => array('title' => $this->l('Middle name'), 'width' => 80, 'filter_key' => 'a!middlename'),
	...
	public function displayForm($isMainTab = true)
	{
		...
		switch ($this->addressType)
		{
			...
			default:
				if ($obj->id)
				{
					...
					<div class="margin-form"><a style="display: block; padding-top: 4px;" href="?tab=AdminCustomers&id_customer='.$customer->id.'&viewcustomer&token='.$tokenCustomer.'">'.$customer->lastname.' '.$customer->firstname .' '.$customer->middlename.' ('.$customer->email.')</a></div>
		...
		foreach($addresses_fields as $addr_field_item)
		{
            ...
            elseif ($addr_field_item == 'middlename')
			{
