...
class AdminPreferences extends AdminTab
{
	public function __construct()
	{
		...
		$this->_fieldsGeneral = array(
			...
			'PS_CART_FOLLOWING' => array('title' => $this->l('Save cart content and re-display it at login'), 'desc' => $this->l('Recall and display contents of shopping cart following customer login'), 'validation' => 'isBool', 'cast' => 'intval', 'type' => 'bool'),
            ...
            // fix added new parametres
            $this->_fieldsGeneral['PS_SHOP_DOLLAR_EXCHANGE_RATE'] = array(
                'title' => $this->l('Dollar Exchange Rate'),
                'desc' => $this->l('Enter Dollar Exchange Rate'),
                'validation' => 'isPrice',
                'cast' => 'floatval',
                'type' => 'text'
            );
			$this->_fieldsGeneral['PS_SHOP_MARKUP'] = array(
                'title' => $this->l('Markup'),
                'desc' => $this->l('Mark-up On Goods In %'),
                'validation' => 'isPrice',
                'cast' => 'floatval',
                'type' => 'text',
                'next' => '%'
            );
            $this->_fieldsGeneral['PS_SHOP_KRESERVE'] = array(
                'title' => $this->l('Кратность резерва'),
                'desc' => $this->l('Кратность резерва'),
                'validation' => 'isPrice',
                'cast' => 'floatval',
                'type' => 'text'
            );
            $this->_fieldsGeneral['PS_SHOP_EXPECTATION'] = array(
                'title' => $this->l('Ожидание выдачи'),
                'desc' => $this->l('Ожидание выдачи(дней)'),
                'validation' => 'isPrice',
                'cast' => 'floatval',
                'type' => 'text',
                'next' => 'дней'
            );
            $this->_fieldsGeneral['PS_SHOP_WAITINGDELIVERY'] = array(
                'title' => $this->l('Ожидание доставки'),
                'desc' => $this->l('Ожидание доставки(дней)'),
                'validation' => 'isPrice',
                'cast' => 'floatval',
                'type' => 'text',
                'next' => 'дней'
