...
class AdminStockMvt extends AdminTab
{
	public function __construct()
	{
		...
		'id_stock_mvt' => array('title' => $this->l('ID'), 'width' => 20),
		'product_name' => array('title' => $this->l('Product Name'), 'width' => 220, 'havingFilter' => true),
		'quantity' => array('title' => $this->l('Quantity'), 'width' => 40),
        'quantity_ordered' => array('title' => $this->l('Quantity ordered'), 'width' => 40), 
        'in_stock' => array('title' => $this->l('In stock'), 'width' => 40), 
		'reason' => array('title' => $this->l('Reason'), 'width' => 150, 'havingFilter' => true),
		...
		echo '</div>
				...
				<div class="margin-form">
					<select name="sign">
                        ...
                        <option value="2">'.$this->l('Increase stock ordered').'</option>
						<option value="-2">'.$this->l('Decrease stock ordered').'</option>
					</select>
				</div>
				<div class="clear space">&nbsp;</div>';
		...
		$movements = $product->getStockMvts((int)$cookie->id_lang);
			...
			<table cellspacing="0" cellpadding="0" class="table widthfull">
				<tr>
                    ...
                    <th>'.$this->l('Quantity ordered').'</th>    
                    <th>'.$this->l('In stock').'</th>
					<th>'.$this->l('Reason').'</th>
	...
	public function display()
	{
		...
		$this->fieldsDisplay = array('id_stock_mvt_reason' => array('title' => $this->l('ID'), 'width' => 40),
												'sign' => array('title' => $this->l('Sign'), 'width' => 15, 'align' => 'center', 'type' => 'select',  'icon' => array(-1 => 'arrow_down.png', 1 => 'arrow_up.png', -2 => 'arrow_down.png', 2 => 'arrow_up.png'), 'orderby' => false),
