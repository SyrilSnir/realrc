	...
	public function __construct()
	{
		...
		switch ((int)(Tools::getValue('entity')))
		{
			...
			case $this->entities[$this->l('Customers')]:
				...
				self::$required_fields = array('email', 'passwd', 'lastname', 'firstname', 'middlename');
                ...
                'middlename' => array('label' => $this->l('Middlename *')),
			...
			case $this->entities[$this->l('Addresses')]:
				...
				self::$required_fields = array('lastname', 'firstname', 'middlename', 'address1', 'postcode', 'country', 'city');
