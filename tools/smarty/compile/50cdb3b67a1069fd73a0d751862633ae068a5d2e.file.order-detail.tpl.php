<?php /* Smarty version Smarty-3.1.11, created on 2021-03-26 17:48:52
         compiled from "F:\OpenServer\domains\realrc.test\themes\p55_gloss_lite\order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:172605df454d5ad48-09582939%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50cdb3b67a1069fd73a0d751862633ae068a5d2e' => 
    array (
      0 => 'F:\\OpenServer\\domains\\realrc.test\\themes\\p55_gloss_lite\\order-detail.tpl',
      1 => 1390293521,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172605df454d5ad48-09582939',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_605df455d98e36_01735616',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_605df455d98e36_01735616')) {function content_605df455d98e36_01735616($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'F:\\OpenServer\\domains\\realrc.test\\tools\\smarty\\plugins\\modifier.escape.php';
if (!is_callable('smarty_function_counter')) include 'F:\\OpenServer\\domains\\realrc.test\\tools\\smarty\\plugins\\function.counter.php';
?>
...
<form action="<?php if (isset($_smarty_tpl->tpl_vars['opc']->value)&&$_smarty_tpl->tpl_vars['opc']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc.php',true);?>
...
" name="id_order"/>
 ...
 <?php echo Tools::dateFormat(array('date'=>$_smarty_tpl->tpl_vars['order']->value->date_add,'full'=>0),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['carrier']->value->id){?><p class="bold"><?php echo smartyTranslate(array('s'=>'Carrier:'),$_smarty_tpl);?>
 <?php if ($_smarty_tpl->tpl_vars['carrier']->value->name=="0"){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['shop_name']->value, 'htmlall', 'UTF-8');?>
...
<p class="bold"><?php echo smartyTranslate(array('s'=>'Payment method:'),$_smarty_tpl);?>
 <span class="color-myaccount"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['order']->value->payment, 'htmlall', 'UTF-8');?>
</span></p>
...
<?php if (!$_smarty_tpl->tpl_vars['is_guest']->value){?><form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-follow.php',true);?>
" method="post"><?php }?>
	...
	<table class="std">
		...
		<tfoot>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value&&$_smarty_tpl->tpl_vars['use_tax']->value){?>
				<tr class="item">
					<td colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value){?>6<?php }else{ ?>5<?php }?>">
						<?php echo smartyTranslate(array('s'=>'Total products (tax excl.):'),$_smarty_tpl);?>
 <span class="price"><?php echo Product::displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->getTotalProductsWithoutTaxes(),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
					</td>
				</tr>
			<?php }?>
...
<?php }?>: <span class="price"><?php echo Product::displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->getTotalProductsWithTaxes(),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
 ...
 <span class="price-discount"><?php echo Product::displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->total_discounts,'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
			<?php }?>
 ...
 <span class="price-wrapping"><?php echo Product::displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->total_wrapping,'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
			<?php }?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['use_tax']->value){?><?php echo smartyTranslate(array('s'=>'(tax incl.)'),$_smarty_tpl);?>
<?php }?>: <span class="price-shipping"><?php echo Product::displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->total_shipping,'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
			<tr class="item">
 ...
 <span class="price"><?php echo Product::displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->total_paid,'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
		</tfoot>
...
?>
			<?php if (!isset($_smarty_tpl->tpl_vars['product']->value['deleted'])){?>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])){?><?php $_smarty_tpl->tpl_vars['productQuantity'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['product_quantity']-$_smarty_tpl->tpl_vars['product']->value['customizationQuantityTotal'], null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['productQuantity'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['product_quantity'], null, 0);?><?php }?>
				<!-- Customized products -->
...
">
								<?php if ($_smarty_tpl->tpl_vars['group_use_tax']->value){?>
									<?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['product']->value['product_price_wt'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>

								<?php }else{ ?>
									<?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['product']->value['product_price'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>
...
">
								<?php if (isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])){?>
									<?php if ($_smarty_tpl->tpl_vars['group_use_tax']->value){?>
										<?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['product']->value['total_customization_wt'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>

									<?php }else{ ?>
										<?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['product']->value['total_customization'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>

									<?php }?>
								<?php }else{ ?>
									<?php if ($_smarty_tpl->tpl_vars['group_use_tax']->value){?>
										<?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['product']->value['total_wt'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>

									<?php }else{ ?>
										<?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['product']->value['total_price'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>
...
<?php }else{ ?>--<?php }?></label></td>
						<td class="bold">
							<label for="cb_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_order_detail']);?>
">
								<?php if ($_smarty_tpl->tpl_vars['product']->value['download_hash']&&$_smarty_tpl->tpl_vars['invoice']->value){?>
									<a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file.php',true);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['is_guest']->value)&&$_smarty_tpl->tpl_vars['is_guest']->value){?>&id_order=<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
&secure_key=<?php echo $_smarty_tpl->tpl_vars['order']->value->secure_key;?>
...
<?php }?><?php echo Product::convertPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['discount']->value['value'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>0),$_smarty_tpl);?>
</td>
...
?>
	...
	<?php }?>
	<form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail.php',true);?>
