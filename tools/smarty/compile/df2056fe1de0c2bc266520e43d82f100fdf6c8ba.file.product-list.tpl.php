<?php /* Smarty version Smarty-3.1.11, created on 2021-03-26 17:30:31
         compiled from "F:\OpenServer\domains\realrc.test\themes\p55_gloss_lite\product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2700605df007e9e633-32356621%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'df2056fe1de0c2bc266520e43d82f100fdf6c8ba' => 
    array (
      0 => 'F:\\OpenServer\\domains\\realrc.test\\themes\\p55_gloss_lite\\product-list.tpl',
      1 => 1456488176,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2700605df007e9e633-32356621',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_605df008485d88_98927635',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_605df008485d88_98927635')) {function content_605df008485d88_98927635($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'F:\\OpenServer\\domains\\realrc.test\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
</a> <?php if (isset($_smarty_tpl->tpl_vars['product']->value['new'])&&$_smarty_tpl->tpl_vars['product']->value['new']==1){?><span class="new"><?php echo smartyTranslate(array('s'=>'New'),$_smarty_tpl);?>
</span><?php }?></h3>
...
"><?php echo smartyTranslate(array('s'=>'Select to compare'),$_smarty_tpl);?>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['prduct']->value['online_only'])&&$_smarty_tpl->tpl_vars['product']->value['online_only']){?><span class="online_only"><?php echo smartyTranslate(array('s'=>'Online only!'),$_smarty_tpl);?>
</span><?php }?>
...
<?php }elseif((isset($_smarty_tpl->tpl_vars['product']->value['quantity_all_versions'])&&$_smarty_tpl->tpl_vars['product']->value['quantity_all_versions']>0)){?><?php echo smartyTranslate(array('s'=>'Product available with different options'),$_smarty_tpl);?>
					...
					<?php }elseif(($_smarty_tpl->tpl_vars['product']->value['quantity_ordered']>0)){?><span style = "color:#C6BC2B"><?php echo smartyTranslate(array('s'=>'In order'),$_smarty_tpl);?>
</span>
						<?php }else{ ?><span class="on_sale"><?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
</span><?php }?></span><?php }?>
				</div>
				<?php }?>
