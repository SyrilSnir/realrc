<?php /* Smarty version Smarty-3.1.11, created on 2021-03-26 17:48:39
         compiled from "F:\OpenServer\domains\realrc.test\themes\p55_gloss_lite\history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20063605df447276223-00213682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '173e81188cc6da764258c65d3975cc5cc192c3ff' => 
    array (
      0 => 'F:\\OpenServer\\domains\\realrc.test\\themes\\p55_gloss_lite\\history.tpl',
      1 => 1390293520,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20063605df447276223-00213682',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_605df4476ce9d6_27988255',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_605df4476ce9d6_27988255')) {function content_605df4476ce9d6_27988255($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'F:\\OpenServer\\domains\\realrc.test\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php if ($_smarty_tpl->tpl_vars['slowValidation']->value){?><p class="warning"><?php echo smartyTranslate(array('s'=>'If you have just placed an order, it may take a few minutes for it to be validated. Please refresh the page if your order is missing.'),$_smarty_tpl);?>
</p><?php }?>
...
, 'order-detail');"><?php echo smartyTranslate(array('s'=>'details'),$_smarty_tpl);?>
					...
					<a href="<?php if (isset($_smarty_tpl->tpl_vars['opc']->value)&&$_smarty_tpl->tpl_vars['opc']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc.php',true);?>
...
"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/my-account.gif" alt="" class="icon" /></a><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account.php',true);?>
