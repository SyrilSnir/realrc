...
session_start();
	...
	public function logout()
	{
		$this->_content = array();
		$this->_setcookie();
		unset($_SESSION['cookie'][$this->_name]);
		$this->_modified = true;
		$this->write();
	}
	...
	public function mylogout()
	{
        ...
        unset($this->_content['customer_middlename']);
	...
	{
		if (isset($_SESSION['cookie'][$this->_name]))
		{
			/* Decrypt cookie content */
			$content = $this->_cipherTool->decrypt($_SESSION['cookie'][$this->_name]);
