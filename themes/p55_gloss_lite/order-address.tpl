...
{/if}
	<div class="addresses">
		...
		<p id="use-same-address" class="checkbox">
		...
		{if $addresses|@count > 1}
			...
			{else}
				<a style="margin-left: 221px;" href="{$link->getPageLink('address.php', true)}?back=order.php?step=2&select_address=1{if $back}&mod={$back}{/if}" title="{l s='Add'}" class="button_large">{l s='Add a new address'}</a>
			{/if}
		</p>
		<div class="clear"></div>
		...
		<p class="address_add submit">
			<a href="{$link->getPageLink('address.php', true)}?back=order.php?step=2{if $back}&mod={$back}{/if}" title="{l s='Add'}" class="button_large">{l s='Add a new address'}</a>
		</p>
	</div>
{if !$opc}
	<p class="cart_navigation submit">
		...
		<a href="{$link->getPageLink('order.php', true)}?step=2{if $back}&back={$back}{/if}" title="{l s='Previous'}" class="button">&laquo; {l s='Previous'}</a>
