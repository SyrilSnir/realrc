...
{else}
	...
	<form id="update-account-info-form" action="{$link->getPageLink('identity.php', true)}" method="post" class="std">
		<fieldset>
			<p class="radio">
				<span>{l s='Title'}</span>
            ...
            <p class="required text">
				...
				<input type="text" name="middlename" id="middlename" value="{$smarty.post.middlename}" /> <sup>*</sup>
			</p>
			<p class="required text">
            ...
            <p class="text">
			<label for="phone_mobile">{l s='Телефон'}</label>
			<input type="text" class="text" name="phone" id="phone_mobile" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}" />
		   </p>
			<p class="required text">
