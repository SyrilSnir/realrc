...
{if isset($order)}
	...
	{else}
		<form method="post" action="{$action|escape:'htmlall':'UTF-8'}#guestToCustomer" class="std" id="convert-guest-account-form">
			<fieldset>
          ...
          <input type="submit" class="exclusive" name="submitTransformGuestToCustomer" value="{l s='Send'}" />
				</p>
