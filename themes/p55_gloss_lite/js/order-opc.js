...
function saveAddress(type)
{
    ...
    params += 'middlename='+encodeURIComponent($('#middlename'+(type == 'invoice' ? '_invoice' : '')).val())+'&';
	...
	if ((!isLogged) || (isGuest))
	{
		if (guestCheckoutEnabled && !isLogged)
		{
			...
			$('#opc_createAccount').click(function() {
				...
				$('#new_account_form').addClass('active');
		...
		$('#submitAccount').click(function() {
            ...
            params += 'customer_middlename='+encodeURIComponent($('#customer_middlename').val())+'&';
