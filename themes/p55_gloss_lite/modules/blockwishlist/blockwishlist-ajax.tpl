...
{else}
	...
	{if isset($error) && $error}
		<dt class="plain-text">{l s='You must create a wishlist before adding products' mod='blockwishlist'}</dt>
	{else}
		<dt class="plain-text">{l s='No products' mod='blockwishlist'}</dt>
	{/if}
	</dl>
{/if}
