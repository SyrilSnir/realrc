		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p class="submit">
					...
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button_small" value="{l s='Log in'}" />
					<span class="lost_password"><a href="{$link->getPageLink('password.php', true)}">{l s='Forgot your password?'}</a></span>
				</p>
			</div>
		</fieldset>
	</form>
		...
		<fieldset>
			...
			<div id="opc_account_form">
                ...
                <p class="required text">
					...
					<input type="text" class="text" id="customer_middlename" name="customer_middlename" onblur="$('#middlename').val($(this).val());" value="{if isset($guestInformations) && $guestInformations.customer_middlename}{$guestInformations.customer_middlename}{/if}" />
					<sup>*</sup>
				</p>
				<p class="select">
				...
				<p class="required text">
					<label for="middlename">{l s='Middle name'}</label>
					<input type="text" class="text" id="middlename" name="middlename" value="{if isset($guestInformations) && $guestInformations.middlename}{$guestInformations.middlename}{/if}" />
					<sup>*</sup>
				</p>
				...
				<div id="opc_invoice_address" class="is_customer_param">
					...
					<p class="required text">
						...
						<input type="text" class="text" id="middlename_invoice" name="middlename_invoice" value="" />
						<sup>*</sup>
					</p>
					{elseif $field_name eq "address1"}
					<p class="required text">
				...
				<p style="float: left; padding-left: 10em;">
